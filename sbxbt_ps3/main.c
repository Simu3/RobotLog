...
//ニュートラル時のデータ
#if FORMAT_RCB3
	const uint8_t neutral_packet[]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,};   //元は 0x80,0x00,0x00,0x40,0x40,0x40,0x40
#elif	FORMAT_RCB4
...
#error	"Unknown format"
	...
	//電文の作成
#if FORMAT_RCB3
	lineBuffer[pos]=sixaxis_button_state&0xff; //lineBuffer[pos++]=(sixaxis_button_state>>8)&0xff;	//2バイト目:ボタン状態デジタル1
	//lineBuffer[pos]=(sixaxis_button_state>>0)&0xff; //lineBuffer[pos++]=(sixaxis_button_state>>0)&0xff;	//3バイト目:ボタン状態デジタル2
	//xyxy

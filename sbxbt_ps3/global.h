...
#define	USE_SPP_SERVER			0		//SPPサーバーとしても並行して動作させるか
#define	USE_USB_HID_CONTROLLER		0		//USB接続のコントローラーも使う
...
#define	UART1_MINIMUM_INTERVAL		50		//電文の周期に制限がある場合(SEND_ON_DIFFERENT_DATA=0の場合) 0:なし 1以上:1電文あたりの最低時間(ms)
...
#define	OUT_DIGITAL_CIRCLE		0x0200//0x0040
#define	OUT_DIGITAL_RECTANGLE           0x0800//0x0080
#define	OUT_DIGITAL_L1			0x0080//0x0200
#define	OUT_DIGITAL_L2			0x0400
#define	OUT_DIGITAL_R1			0x0040//0x0800
#define	OUT_DIGITAL_R2			0x1000
#define	OUT_DIGITAL_START		0x0000
#define	OUT_DIGITAL_SELECT		0x0000

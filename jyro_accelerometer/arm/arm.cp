#line 1 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/arm/arm.c"
#line 21 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/arm/arm.c"
void SetUp();
...
void Main()
{
 ...
 roll += (jyro_x *  (0.000128 * (double)TMR0) ) - ( (2.0 * 3.141592654  * 0.37 )  * roll *  (0.000128 * (double)TMR0) ) + ( (2.0 * 3.141592654  * 0.37 )  * theta_x *  (0.000128 * (double)TMR0) );
 pitch += (jyro_y *  (0.000128 * (double)TMR0) ) - ( (2.0 * 3.141592654  * 0.37 )  * pitch *  (0.000128 * (double)TMR0) ) + ( (2.0 * 3.141592654  * 0.37 )  * theta_y *  (0.000128 * (double)TMR0) );
 ...
 pitch = -18.0;
#line 99 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/arm/arm.c"
 }
}
...
void SetUp()
{
 ...
 UART1_Init(115200);
#line 136 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/arm/arm.c"
 Delay_ms(10);
}

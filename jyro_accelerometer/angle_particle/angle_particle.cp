#line 1 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_particle/angle_particle.c"
...
void Main()
{
 ...
 particle[i].weight = (1.0 / sqrt(2.0 *  3.141592654 )) * exp(-1.0 * pow(d, 2.0) / (2.0 * pow(sigma, 2.0)));
 }

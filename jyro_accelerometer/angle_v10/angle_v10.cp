#line 1 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v10/angle_v10.c"
#line 18 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v10/angle_v10.c"
void SetUp();
...
void Main()
{
 ...
 accele_x[0] = accele_x[1] * (1.0 -  0.1 ) + accele_x[0] *  0.1 ;
 accele_y[0] = accele_y[1] * (1.0 -  0.1 ) + accele_y[0] *  0.1 ;
 accele_z[0] = accele_z[1] * (1.0 -  0.1 ) + accele_z[0] *  0.1 ;
 ...
 roll = (roll + (jyro_x[1] + jyro_x[0]) *  (0.000128 * (double)TMR0)  * 0.5) * (1.0 -  0.07 )
 + atan(accele_x[0] / sqrt(accele_y[0] * accele_y[0] + accele_z[0] * accele_z[0])) * (180.0 /  3.141592654 ) *  0.07 ;
 pitch = (pitch + (jyro_y[1] + jyro_y[0]) *  (0.000128 * (double)TMR0)  * 0.5) * (1.0 -  0.07 )
 + atan(accele_y[0] / sqrt(accele_x[0] * accele_x[0] + accele_z[0] * accele_z[0])) * (180.0 /  3.141592654 ) *  0.07 ;
 ...
 pitch = 0.0;
#line 107 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v10/angle_v10.c"

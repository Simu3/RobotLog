...
#define COMPLEMENT_COEFFICIENT 0.07
...
void Main()
{
  ...
  while(1){
   while(ARM_STATE == 0){
    ...
    //WMA -> LPF
    accele_x[0] = accele_x[1] * (1.0 - LPF_COEFFICIENT) + accele_x[0] * LPF_COEFFICIENT;
    accele_y[0] = accele_y[1] * (1.0 - LPF_COEFFICIENT) + accele_y[0] * LPF_COEFFICIENT;
    accele_z[0] = accele_z[1] * (1.0 - LPF_COEFFICIENT) + accele_z[0] * LPF_COEFFICIENT;

#line 1 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v2/angle_v2.c"
...
void main()
{
 ...
 ax_bias=ay_bias=jx_bias=jy_bias=ax=ay=az=jx=jy=0.0;
 x=y=0;
...
void debug(int x, int y, int jx, int jy)
{
 UART_write((x>=0) ? '+' : '-');
 x=abs(x);

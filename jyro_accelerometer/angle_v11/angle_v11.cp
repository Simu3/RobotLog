#line 1 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v11/angle_v11.c"
#line 18 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v11/angle_v11.c"
void SetUp();
...
void Main()
{
 ...
 while(1){
#line 61 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v11/angle_v11.c"
 TMR0 = 0;
 ...
 jyro_x[0] = (ADC_read( 3 ) - jyro_x_bias) *  (5.0 / 1024.0 * 0.0067) ;
 jyro_y[0] = (ADC_read( 4 ) - jyro_y_bias) *  (5.0 / 1024.0 * 0.0067) ;


 accele_x[1] += (accele_x[0] - accele_x[1]) * (1.0 - exp(-2.0 *  3.141592654  * f *  (0.000128 * (double)TMR0) ));
 accele_y[1] += accele_y[1] * (1.0 -  0.1 ) + accele_y[0] *  0.1 ;
 accele_z[1] += accele_z[1] * (1.0 -  0.1 ) + accele_z[0] *  0.1 ;


 jyro_x[0] = jyro_x[0] - (jyro_x[1] * (1.0 -  0.1 ) + jyro_x[0] *  0.1 );
 jyro_y[0] = jyro_y[0] - (jyro_y[1] * (1.0 -  0.1 ) + jyro_y[0] *  0.1 );




 roll = (roll + (jyro_x[1] + jyro_x[0]) *  (0.000128 * (double)TMR0)  * 0.5) * (1.0 -  0.08 )
 + atan(accele_x[0] / sqrt(accele_y[0] * accele_y[0] + accele_z[0] * accele_z[0])) * (180.0 /  3.141592654 ) *  0.08 ;
 pitch = (pitch + (jyro_y[1] + jyro_y[0]) *  (0.000128 * (double)TMR0)  * 0.5) * (1.0 -  0.08 )
 + atan(accele_y[0] / sqrt(accele_x[0] * accele_x[0] + accele_z[0] * accele_z[0])) * (180.0 /  3.141592654 ) *  0.08 ;
 ...
 Debug(roll, pitch);
#line 105 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v11/angle_v11.c"
...
#line 147 "C:/Users/i121326/Documents/workspace/robot/jyro_accelerometer/angle_v11/angle_v11.c"
 Delay_ms(10);
}

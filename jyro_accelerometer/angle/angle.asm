...
;angle.c,34 :: 		void Main()
;angle.c,36 :: 		double accele_x_bias   = 0.0, accele_y_bias   = 0.0;
...
;angle.c,45 :: 		Setup();
	CALL       _Setup+0
;angle.c,47 :: 		Set_Bias(&accele_x_bias, &accele_y_bias, &jyro_x_bias, &jyro_y_bias);
	MOVLW      Main_accele_x_bias_L0+0
...
;angle.c,50 :: 		TMR0 = 0;
	CLRF       TMR0+0
;angle.c,52 :: 		accele_x = ADC_read(ANAROG_PIN_ACCELE_X) - accele_x_bias;
...
;angle.c,53 :: 		accele_y = ADC_read(ANAROG_PIN_ACCELE_Y) - accele_y_bias;
	MOVLW      1
...
;angle.c,54 :: 		accele_z = ADC_read(ANAROG_PIN_ACCELE_Z) - ACCELE_Z_BIAS;
	MOVLW      2
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
...
;angle.c,55 :: 		jyro_x   = ADC_read(ANAROG_PIN_JYRO_X)   - jyro_x_bias;
	MOVLW      3
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
...
;angle.c,56 :: 		jyro_y   = ADC_read(ANAROG_PIN_JYRO_Y)   - jyro_y_bias;
	MOVLW      4
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
...
;angle.c,58 :: 		static_angle_x = Static_Angle(accele_x, accele_y, accele_z);                //ê√ìIäpìxÇÃéZèo
...
;angle.c,59 :: 		static_angle_y = Static_Angle(accele_y, accele_x, accele_z);
	MOVF       Main_accele_x_L0+0, 0
	MOVWF      R0
	MOVF       Main_accele_x_L0+1, 0
	MOVWF      R1
...
;angle.c,61 :: 		dynamic_angle_x = Dynamic_Angle(jyro_x);                                    //ìÆìIäpìxÇÃéZèo
...
;angle.c,62 :: 		dynamic_angle_y = Dynamic_Angle(jyro_y);
...
;angle.c,64 :: 		angle_x = Composition_Of_Angle(angle_x, static_angle_x, dynamic_angle_x);   //äpìxÇÃçáê¨
	MOVLW      59
	MOVWF      R0
	MOVLW      70
	MOVWF      R1
...
;angle.c,65 :: 		angle_y = Composition_Of_Angle(angle_y, static_angle_y, dynamic_angle_y);
	MOVLW      59
	MOVWF      R0
	MOVLW      70
	MOVWF      R1
...
;angle.c,70 :: 		Output(-angle_x * 0.8, -angle_y * 0.8, static_angle_x, static_angle_y);
	MOVLW      0
...
;angle.c,76 :: 		void Setup()
;angle.c,78 :: 		OSCCON = 0x70;
	MOVLW      112
	MOVWF      OSCCON+0
;angle.c,80 :: 		OPTION_REG = 0x07;  //É^ÉCÉ}Å[0ê›íË
	MOVLW      7
	MOVWF      OPTION_REG+0
;angle.c,82 :: 		ANSELA = 0x2F;
	MOVLW      47
	MOVWF      ANSELA+0
;angle.c,83 :: 		ANSELB = 0x00;
	CLRF       ANSELB+0
;angle.c,84 :: 		ANSELD = 0x00;
	CLRF       ANSELD+0
;angle.c,85 :: 		ANSELE = 0x00;
	CLRF       ANSELE+0
;angle.c,87 :: 		TRISA  = 0x2F;
	MOVLW      47
	MOVWF      TRISA+0
;angle.c,88 :: 		TRISB  = 0x00;
	CLRF       TRISB+0
;angle.c,89 :: 		TRISC  = 0x00;
	CLRF       TRISC+0
;angle.c,90 :: 		TRISD  = 0x00;
	CLRF       TRISD+0
;angle.c,91 :: 		TRISE  = 0x00;
	CLRF       TRISE+0
;angle.c,93 :: 		PORTA  = 0x00;
	CLRF       PORTA+0
;angle.c,94 :: 		PORTB  = 0x00;
	CLRF       PORTB+0
;angle.c,95 :: 		PORTC  = 0x00;
	CLRF       PORTC+0
;angle.c,96 :: 		PORTD  = 0x00;
	CLRF       PORTD+0
;angle.c,97 :: 		PORTE  = 0x00;
	CLRF       PORTE+0
;angle.c,99 :: 		ADC_Init();
	CALL       _ADC_Init+0
;angle.c,101 :: 		UART1_Init(9600);
	BSF        BAUDCON+0, 3
	MOVLW      207
	MOVWF      SPBRG+0
	CLRF       SPBRG+1
	BSF        TXSTA+0, 2
	CALL       _UART1_Init+0
;angle.c,105 :: 		Soft_UART_Init(&PORTB, 6, 4, 9600, 0);
	MOVLW      PORTB+0
...
;angle.c,111 :: 		void Set_bias(double *accele_x_bias, double *accele_y_bias, double *jyro_x_bias, double *jyro_y_bias)
;angle.c,115 :: 		for(i = 0; i < 100; i ++){
...
L__Set_bias74:
	BTFSC      STATUS+0, 0
	GOTO       L_Set_bias4
;angle.c,116 :: 		*accele_x_bias += ADC_Read(ANAROG_PIN_ACCELE_X);
	CLRF       FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,117 :: 		*accele_y_bias += ADC_Read(ANAROG_PIN_ACCELE_Y);
	MOVLW      1
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,118 :: 		*jyro_x_bias   += ADC_Read(ANAROG_PIN_JYRO_X);
	MOVLW      3
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,119 :: 		*jyro_y_bias   += ADC_Read(ANAROG_PIN_JYRO_Y);
	MOVLW      4
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	CALL       _Word2Double+0
...
;angle.c,120 :: 		}
	GOTO       L_Set_bias3
L_Set_bias4:
;angle.c,122 :: 		*accele_x_bias /= 100.0;
	MOVF       FARG_Set_bias_accele_x_bias+0, 0
	MOVWF      FSR0L
	MOVF       FARG_Set_bias_accele_x_bias+1, 0
	MOVWF      FSR0H
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,123 :: 		*accele_y_bias /= 100.0;
	MOVF       FARG_Set_bias_accele_y_bias+0, 0
	MOVWF      FSR0L
	MOVF       FARG_Set_bias_accele_y_bias+1, 0
	MOVWF      FSR0H
...
;angle.c,128 :: 		void Rotate_Converter(double angle_x, double angle_y, double *right_rotate, double *left_rotate)
;angle.c,130 :: 		*right_rotate  = (angle_x >= 0.0) ?  angle_x * 0.5 : -angle_x * 0.5;  //âEë§Ç…åXÇ¢ÇΩÇÁè„Ç…ìÆÇ©Ç∑
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Rotate_Converter7:
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,131 :: 		*right_rotate += (angle_y >= 0.0) ? -angle_y :  angle_y;  //ëOï˚Ç…åXÇ¢ÇΩÇÁâ∫Ç…ìÆÇ©Ç∑
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Rotate_Converter9:
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,132 :: 		*left_rotate   = (angle_x >= 0.0) ? -angle_x * 0.5 :  angle_x * 0.5;  //âEë§Ç…åXÇ¢ÇΩÇÁâ∫Ç…ìÆÇ©Ç∑
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Rotate_Converter11:
	...
	ADDFSR     1, 1
	MOVWF      INDF1+0
;angle.c,133 :: 		*left_rotate  += (angle_y >= 0.0) ? -angle_y :  angle_y;  //ëOï˚Ç…åXÇ¢ÇΩÇÁâ∫Ç…ìÆÇ©Ç∑
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
;angle.c,136 :: 		void Output(double data1, double data2, double data3, double data4)
;angle.c,138 :: 		double angle_x = 0.0, angle_y = 0.0;
...
;angle.c,143 :: 		if(DEAD_ANGLE_AREA_MIN < data3 && data3 < DEAD_ANGLE_AREA_MAX)
	...
	GOTO       L_Output16
L__Output68:
;angle.c,144 :: 		angle_x = 0.0;
	CLRF       Output_angle_x_L0+0
	CLRF       Output_angle_x_L0+1
	CLRF       Output_angle_x_L0+2
	CLRF       Output_angle_x_L0+3
L_Output16:
;angle.c,145 :: 		if(DEAD_ANGLE_AREA_MIN < data4 && data4 < DEAD_ANGLE_AREA_MAX)
	...
	GOTO       L_Output19
L__Output67:
;angle.c,146 :: 		angle_y = 0.0;
	CLRF       Output_angle_y_L0+0
	CLRF       Output_angle_y_L0+1
	CLRF       Output_angle_y_L0+2
	CLRF       Output_angle_y_L0+3
L_Output19:
;angle.c,148 :: 		if(data1 >= ANGLE_X_MAX)
	MOVLW      0
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Output20
;angle.c,149 :: 		angle_x = ANGLE_X_MAX;
	MOVLW      0
	MOVWF      Output_angle_x_L0+0
	MOVLW      0
	MOVWF      Output_angle_x_L0+1
	...
	GOTO       L_Output21
L_Output20:
;angle.c,150 :: 		else if(data1 <= ANGLE_X_MIN)
	MOVF       FARG_Output_data1+0, 0
	MOVWF      R4
	MOVF       FARG_Output_data1+1, 0
	MOVWF      R5
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Output22
;angle.c,151 :: 		angle_x = ANGLE_X_MIN;
	MOVLW      0
	MOVWF      Output_angle_x_L0+0
	MOVLW      0
	MOVWF      Output_angle_x_L0+1
...
L_Output22:
L_Output21:
;angle.c,152 :: 		if(data2 >= ANGLE_Y_MAX)
	MOVLW      0
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Output23
;angle.c,153 :: 		angle_y = ANGLE_Y_MAX;
	MOVLW      0
	MOVWF      Output_angle_y_L0+0
	MOVLW      0
	MOVWF      Output_angle_y_L0+1
	...
	GOTO       L_Output24
L_Output23:
;angle.c,154 :: 		else if(data2 <= ANGLE_Y_MIN)
	MOVF       FARG_Output_data2+0, 0
	MOVWF      R4
	MOVF       FARG_Output_data2+1, 0
	MOVWF      R5
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Output25
;angle.c,155 :: 		angle_y = ANGLE_Y_MIN;
	MOVLW      0
	MOVWF      Output_angle_y_L0+0
	MOVLW      0
	MOVWF      Output_angle_y_L0+1
...
;angle.c,161 :: 		UART1_Write(0);
	CLRF       FARG_UART1_Write_data_+0
	CALL       _UART1_Write+0
;angle.c,162 :: 		UART1_Write((data1 >= 0.0) ? 0 : 1);                             //+ : 0 - : 1
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Output27:
	...
	CALL       _UART1_Write+0
;angle.c,163 :: 		UART1_Write((data1 >= 0.0) ? (data1 * 10.0) : (-data1 * 10.0));  //âÒì]äpÉfÅ[É^
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Output29:
	...
	MOVWF      FARG_UART1_Write_data_+0
	CALL       _UART1_Write+0
;angle.c,165 :: 		Soft_UART_Write(0);
	CLRF       FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,166 :: 		Soft_UART_Write((data2 >= 0.0) ? 0 : 1);
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Output31:
	...
	CALL       _Soft_UART_Write+0
;angle.c,167 :: 		Soft_UART_Write((data2 >= 0.0) ? (data2 * 10.0) : (-data2 * 10.0));
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
;angle.c,170 :: 		void Debug(double data1, double data2, double data3, double data4)
;angle.c,174 :: 		if(DEAD_ANGLE_AREA_MIN < data3 && data3 < DEAD_ANGLE_AREA_MAX)
...
;angle.c,180 :: 		data1 = ANGLE_X_MAX;
	...
	GOTO       L_Debug41
L_Debug40:
;angle.c,181 :: 		else if(data1 <= ANGLE_X_MIN)
	MOVF       FARG_Debug_data1+0, 0
	MOVWF      R4
	MOVF       FARG_Debug_data1+1, 0
	MOVWF      R5
...
L_Debug42:
L_Debug41:
;angle.c,183 :: 		if(data2 >= ANGLE_Y_MAX)
	MOVLW      0
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
...
;angle.c,184 :: 		data2 = ANGLE_Y_MAX;
	...
	GOTO       L_Debug44
L_Debug43:
;angle.c,185 :: 		else if(data2 <= ANGLE_Y_MIN)
	MOVF       FARG_Debug_data2+0, 0
	MOVWF      R4
	MOVF       FARG_Debug_data2+1, 0
	MOVWF      R5
...
L_Debug45:
L_Debug44:
;angle.c,188 :: 		Soft_UART_Write((data1 >= 0.0) ? '+' : '-');
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Debug47:
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,189 :: 		tmp = (data1 >= 0.0) ? data1 * 10.0 : -data1 * 10.0;
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
;angle.c,190 :: 		Soft_UART_Write(Dec2Ascii((tmp % 1000 - tmp % 100) / 100));
	MOVLW      232
	MOVWF      R4
	MOVLW      3
	MOVWF      R5
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,191 :: 		Soft_UART_Write(Dec2Ascii((tmp % 100 - tmp % 10) / 10));
	MOVLW      100
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,192 :: 		Soft_UART_Write('.');
	MOVLW      46
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,193 :: 		Soft_UART_Write(Dec2Ascii(tmp % 10));
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,194 :: 		Soft_UART_Write(' ');
	MOVLW      32
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,196 :: 		Soft_UART_Write((data2 >= 0.0) ? '+' : '-');
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Debug51:
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,197 :: 		tmp = (data2 >= 0.0) ? data2 * 10.0 : -data2 * 10.0;
	CLRF       R4
	CLRF       R5
	CLRF       R6
	CLRF       R7
...
L_Debug53:
	...
	MOVF       R1, 0
	MOVWF      Debug_tmp_L0+1
;angle.c,198 :: 		Soft_UART_Write(Dec2Ascii((tmp % 1000 - tmp % 100) / 100));
	MOVLW      232
	MOVWF      R4
	MOVLW      3
	MOVWF      R5
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,199 :: 		Soft_UART_Write(Dec2Ascii((tmp % 100 - tmp % 10) / 10));
	MOVLW      100
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,200 :: 		Soft_UART_Write('.');
	MOVLW      46
	MOVWF      FARG_Soft_UART_Write_udata+0
	CALL       _Soft_UART_Write+0
;angle.c,201 :: 		Soft_UART_Write(Dec2Ascii(tmp % 10));
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
...
;angle.c,205 :: 		char Dec2Ascii(char dec)
;angle.c,207 :: 		switch(dec){
	GOTO       L_Dec2Ascii54
;angle.c,208 :: 		case 0:  return '0';
L_Dec2Ascii56:
	MOVLW      48
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,209 :: 		case 1:  return '1';
L_Dec2Ascii57:
	MOVLW      49
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,210 :: 		case 2:  return '2';
L_Dec2Ascii58:
	MOVLW      50
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,211 :: 		case 3:  return '3';
L_Dec2Ascii59:
	MOVLW      51
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,212 :: 		case 4:  return '4';
L_Dec2Ascii60:
	MOVLW      52
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,213 :: 		case 5:  return '5';
L_Dec2Ascii61:
	MOVLW      53
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,214 :: 		case 6:  return '6';
L_Dec2Ascii62:
	MOVLW      54
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,215 :: 		case 7:  return '7';
L_Dec2Ascii63:
	MOVLW      55
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,216 :: 		case 8:  return '8';
L_Dec2Ascii64:
	MOVLW      56
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,217 :: 		case 9:  return '9';
L_Dec2Ascii65:
	MOVLW      57
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
;angle.c,218 :: 		default: return '*';
L_Dec2Ascii66:
	MOVLW      42
	MOVWF      R0
	GOTO       L_end_Dec2Ascii
